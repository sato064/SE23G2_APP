...
df = pd.DataFrame({'第1回機能仕様書インスペクション結果': srs1,'第2回機能仕様書インスペクション結果': srs2,'第1回クラス図インスペクション結果': c1, '第2回クラス図インスペクション結果': c2, '第1回画面シナリオインスペクション結果': UI1, '第1回データベースインスペクション結果': DB1},
